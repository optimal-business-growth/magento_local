...
echo -e "\e[32mInsalling and Configuring Mysql\e[0m"  # Green color
...
sudo -u ${OSUser} composer create-project --no-install --repository-url=https://repo.magento.com/ magento/project-community-edition=2.4.3 magento2
cd magento2
